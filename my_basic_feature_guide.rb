...
# explains why the feature is there in the first place. 

# 2. scenario: where the actual tests live. 
# this will be built around keywords
# this will describe what the software is doing
# Given, When and Then
# this should provide a good idea of what the software ought to be doing.
